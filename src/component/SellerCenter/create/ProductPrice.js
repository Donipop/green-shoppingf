...
export default function ProductPrice() {
  ...
  const onChangePrice = (e) => {
    ...
    if (e.target.id === "product-count") {
      setProduct(
        (product) => (product = { ...product, product_count: price2 })
      );
    }
  };
  ...
  const onClickButton = (e) => {
    ...
    if (e.target.id === "discount-false") {
      ...
      //콜랩스 닫기
      document
        .getElementById("discount-true-collapse")
  ...
  return (
    <>
      ...
      <Div>
        ...
        <br />
        <Button onClick={onClickButton} id="discount-true">
          설정함
        </Button>
        <Button onClick={onClickButton} id="discount-false">
          설정안함
        </Button>
      ...
      <div>
        ...
        <br />
        <Button onClick={onClickButton} id="date-true">
          설정함
        </Button>
        <Button onClick={onClickButton} id="date-false">
          설정안함
        </Button>
