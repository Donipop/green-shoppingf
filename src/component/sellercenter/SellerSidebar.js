            ...
            <li className="mb-1">
              ...
              <div className="collapse" id="sell-collapse">
                <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                  ...
                  <li>
                    <a
                      href="/sellercenter/totalorderlist"
                      className="link-white d-inline-flex text-decoration-none rounded"
                    >
                      주문통합검색
                    </a>
                  ...
                  <li>
                    <a
                      href="/sellercenter/orderconfirm"
                      className="link-white d-inline-flex text-decoration-none rounded"
                    >
                      구매확정 내역
                    </a>
            ...
            <li className="mb-1">
              ...
              <div className="collapse" id="sell-collapse2">
                <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                  ...
                  <li>
                    <a
                      href="/sellercenter/sellersettlement"
                      className="link-white d-inline-flex text-decoration-none rounded"
                    >
                      정산하기
                    </a>
