...
function ViewDetailProductInfo({ productInfo }) {
  ...
  useEffect(() => {
    ...
    //상세상품 받아오기
    axios
      .get("/api/sellercenter/getorderdetail", {
        params: {
      ...
      .then((res) => {
        ...
        //유저정보 받아오기
        axios
          .get("/api/sellercenter/getpostaddress", {
            params: {
  ...
  const onClickConfirm = () => {
    ...
    axios
      .post("/api/sellercenter/updateorderstatus", {
              ...
              >
                <li>
                  <span
                    ...
                    onClick={(e) => onClickOrderState(e, 0)}
                  >
                    주문접수
                  </span>
                </li>
                <li>
                  <span
                    className="dropdown-item"
                    onClick={(e) => onClickOrderState(e, 1)}
                  >
                    결제완료
                  </span>
                </li>
                <li>
                  <span
                    className="dropdown-item"
                    onClick={(e) => onClickOrderState(e, 2)}
                  >
                    배송준비중
                  </span>
                </li>
                <li>
                  <span
                    className="dropdown-item"
                    onClick={(e) => onClickOrderState(e, 3)}
                  >
                    배송중
                  </span>
                </li>
                <li>
                  <span
                    className="dropdown-item"
                    onClick={(e) => onClickOrderState(e, 4)}
                  >
                    배송완료
                  </span>
                </li>
                <li>
                  <span
                    className="dropdown-item"
                    onClick={(e) => onClickOrderState(e, 5)}
                  >
                    구매확정
                  </span>
                </li>
                <li>
                  <span
                    className="dropdown-item"
                    onClick={(e) => onClickOrderState(e, 6)}
                  >
                    주문취소
                  </span>
                </li>
