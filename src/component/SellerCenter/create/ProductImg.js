        ...
        try {
          ...
          reader.onload = (e) => {
            ...
            if (mainImgRef.current.childElementCount === 0) {
              ...
              mainImgRef.current.replaceChild(
                cimg,
                mainImgRef.current.childNodes[0]
              );
            }
            // 이미지 클릭시 삭제
            cimg.onclick = (e) => {
        ...
        <div className="product-img_upload">
          ...
          <div className="product-img_upload_content d-flex">
            <div className="product-img_upload_content_img">
              ...
              >
                <img
                  src="https://via.placeholder.com/150?text=Add"
                  alt="상품 이미지"
                />
              </Button>
              <div id="product-mainImgs" ref={mainImgRef}></div>
            </div>
          </div>
        </div>
