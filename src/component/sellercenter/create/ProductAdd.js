...
export default function ProductAdd({ getData, UpdateData }) {
  ...
  const onClickButton = (e) => {
    ...
    if (e.target.id === "discount-true-add") {
      ...
      //콜랩스 열기
      document
        .getElementById("discount-true-add-collapse")
        .classList.add("show");
    }
    ...
    if (e.target.id === "date-fasle-add") {
      ...
      //콜랩스 닫기
      document
        .getElementById("date-true-add-collapse")
        .classList.remove("show");
    }
  };
  /**
  ...
  return (
    <>
      ...
      <Div>
        ...
        <br />
        <Button onClick={onClickButton} id="discount-true-add">
          설정함
        </Button>
        <Button onClick={onClickButton} id="discount-fasle-add">
          설정안함
        </Button>
      ...
      <div>
        ...
        <br />
        <Button onClick={onClickButton} id="date-true-add">
          설정함
        </Button>
        <Button onClick={onClickButton} id="date-fasle-add">
          설정안함
        </Button>
      ...
      <small>
        판매기간을 설정하지 않으면 제품이 등록된 순간 바로 올라갑니다
      </small>
      <small>
        시작날짜은 설정하지 않으면 제품이 등록된 순간 바로 올라갑니다
      </small>
      <small>
        종료날짜를 설정하지 않으면 시작날짜 이후부터 제품을 내리기 전까지
        등록됩니다
      </small>
      <Hr />
      ...
      <div>
        ...
        <div className="input-group">
          ...
          <input
            type="text"
            id="product-count-add"
            className="form-control"
            placeholder="제고수량을 입력해주세요."
            onChange={onChangePrice}
          />
          <span className="input-group-text" onChange={onChangePrice}>
            개
          </span>
        </div>
      </div>
