...
function SellerSettleDate({getDate}){
    ...
    setDateInfo({
        start: alltimeago.getFullYear() + '-' + ( (alltimeago.getMonth()) <= 9 ? "0" + (alltimeago.getMonth()) : (alltimeago.getMonth()) ) +
                    '-' + ( (alltimeago.getDate()) < 9 ? "0" + (alltimeago.getDate()) : (alltimeago.getDate()) ),
        end: year + '-' + (month <= 9 ? "0" + month : month) + '-' + (day <= 9 ? "0" + day : day)
    })
    }, [])
    ...
    const onClickOneClickDate = (index) => {
        ...
        let month3 = new Date(date.getFullYear(), date.getMonth() - 3, date.getDate());
        let month6 = new Date(date.getFullYear(), date.getMonth() - 6, date.getDate());
        let month12 = new Date(date.getFullYear() - 1, date.getMonth(), date.getDate());
        let alltimeago = new Date(2000, 1, 1);
        ...
        switch(index){
            case 0:
                ...
                setDateInfo({
                    ...dateInfo,
                    start: year + '-' + (month <= 9 ? "0" + month : month) + '-' + (day <= 9 ? "0" + day : day),
                    end: year + '-' + (month <= 9 ? "0" + month : month) + '-' + (day <= 9 ? "0" + day : day)
                })
                break;
            case 1:
            ...
            case 4:
                ...
                setDateInfo({
                    ...dateInfo,
                    start: month6.getFullYear() + '-' + ( (month6.getMonth()+1) <= 9 ? "0" + (month6.getMonth()+1) : (month6.getMonth()+1) ) +
            ...
            case 5:
                ...
                setDateInfo({
                    ...dateInfo,
                    start: month12.getFullYear() + '-' + ( (month12.getMonth()+1) <= 9 ? "0" + (month12.getMonth()+1) : (month12.getMonth()+1) ) +
                    '-' + ( (month12.getDate()) < 9 ? "0" + (month12.getDate()) : (month12.getDate()) ),
                    end : year + '-' + (month <= 9 ? "0" + month : month) + '-' + (day <= 9 ? "0" + day : day)
                })
                break;
            case 6:
                ...
                <div className="row">
                    ...
                    <div className="col-12 d-flex mt-3">
                        <div className="btn-group" aria-label="dateBtnGroup">
                            ...
                            <button type="button" className="btn btn-secondary" onClick={() => onClickOneClickDate(1)} >이번달</button>
                            <button type="button" className="btn btn-secondary" onClick={() => onClickOneClickDate(2)} >저번달</button>
                            <button type="button" className="btn btn-secondary" onClick={() => onClickOneClickDate(3)} >3개월</button>
                            <button type="button" className="btn btn-secondary" onClick={() => onClickOneClickDate(4)} >6개월</button>
                            <button type="button" className="btn btn-secondary" onClick={() => onClickOneClickDate(5)} >1년</button>
                            <button type="button" className="btn btn-secondary" onClick={() => onClickOneClickDate(6)} >전체</button>
                        </div>
