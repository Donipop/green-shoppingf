...
function OrderConfirmDate({ getDate }) {
        ...
        setDateInfo({
          ...
          start:
            ...
            (week.getMonth() + 1 <= 9
              ...
              : week.getMonth() + 1) +
            "-" +
            (week.getDate() <= 9 ? "0" + week.getDate() : week.getDate()),
          end:
            year +
            "-" +
            (month <= 9 ? "0" + month : month) +
        ...
        setDateInfo({
          ...
          start:
            ...
            (month1.getMonth() + 1 <= 9
              ...
              : month1.getMonth() + 1) +
            "-" +
            (month1.getDate() <= 9 ? "0" + month1.getDate() : month1.getDate()),
          end:
            year +
            "-" +
            (month <= 9 ? "0" + month : month) +
...
export default OrderConfirmDate;
